...
void
wait_end_of_input(int32_t in_fd, char *input)
{
    char *current;
    do { 
        current = input;
...
void
send_data(int32_t fd, char *file)
{
...
void
work_with(int32_t in_fd, const char* path)
{
    char name[MAX_SIZE];
    char input[MAX_SIZE];
